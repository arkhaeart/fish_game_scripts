...
//using DataHandlerInfo, which is filled manually in DataHandlerCustomClass
// init signature is         DataHandler.Init(DataHandlerCustomClass.GetDataHandlerInfo());
...
namespace Persistence
{
    public static partial class DataHandler
    {
        ...
        public static void Init(DataHandlerInfo info)
        {
        ...
        public static async void HandlingAsyncRequests()
        {
            ...
            while(true)
            {
                if(asyncRequests.Count>0)
                {
                    ...
                    {
                        Debug.Log("It is reading request");
                    }
                    else
                    {
