...
public class MyCour<T1,T2>
{
    readonly System.Func<T1, T2,IEnumerator> func;
    Coroutine cour, subcour;
    readonly MonoBehaviour mono;

    public MyCour(MonoBehaviour mono, System.Func<T1,T2, IEnumerator> func)
    {
        this.mono = mono;
        this.func = func;
    }
    public void Run(T1 param1,T2 param2)
    {
        ...
        cour = mono.StartCoroutine(Process(param1,param2));
    }
    IEnumerator Process(T1 param1,T2 param2)
    {
        subcour = mono.StartCoroutine(func?.Invoke(param1,param2));
        yield return subcour;
        cour = null;
        subcour = null;
    }
